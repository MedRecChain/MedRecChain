        ...
        <section className=" py-5">
          <div className="py-3">
            <div className="">
              <div className=" mx-auto w-75 my-5 bg-opacity-10">
                <div className="">
                  <div className="row">
                    <img src={aboutImg} alt="aboutImg" className="col-xl-6 rounded-start" height="" />
                    <div className="col-xl-5 p-5 pt-5" >
                      <h1 className=" my-4">How can we help you?</h1>
                      <p className="">
                        We seek to put the patients in control of their medical data,
            ...
            <div className="container-fluid prob">
              <div className="row mx-auto w-75">
                <div className="icon-boxes d-flex flex-column align-items-stretch justify-content-center py-1 px-lg-5">
                  ...
                  <div className="icon-box">
                    <div className="icon">
                      4 {/* <Icon icon="emojione-monotone:money-mouth-face" className="pro-sol" /> */}
                    </div>
                    <h4 className="title">
                      Time and Money
                    </h4>
          ...
          <section id="about" className="about">
            <div className="bg-success bg-opacity-50 p-5 mt-5 text-center">
              <h1>Our Solutions</h1>
              <p>
                MedRecChain provides a decentralized easy to use Electronic Medical Record system(EMR). It is a free web application providing a feature rich as well as interactive UI making it easy to use.
              </p>
            </div>
          ...
          <div className="my-5">
            <div className="text-center py-5 px-3 bg-info bg-opacity-50">
              ...
              <p className="my-4 w-75 text-center mx-auto text-muted">Welcome to the future of healthcare! Our medical health record platform, powered by blockchain, ethereum, and other state-of-the-art technologies, is changing the way medical information is stored and shared.</p>
            </div>
            <div className="features m-5">
              <div className="mx-5 forms row d-flex justify-content-evenly">
                <div className="col-xl-4 w-25 card requests px-4 py-3">
                  <img src={img1} alt="aboutImg" className="rounded-top" height="200px" />
                  <h4 className="fw-bold py-4">Collaboration</h4>
                  <p className="pb-3">Our team of blockchain, ethereum, and web development work together to build a user-friendly and secure website for medical health record. </p>
                </div>
                <div className="col-xl-4 w-25 card requests px-4 py-3">
                  <img src={img2} alt="aboutImg" className="rounded-top" height="200px" />
                  <h4 className="fw-bold py-4">Security</h4>
                  <p className="pb-3">Using blockchain technology and encryption, our website ensures secure and private storage and sharing of medical health records.</p>
                </div>
                <div className="col-xl-4 w-25 card requests px-4 py-3">
                  <img src={img3} alt="aboutImg" className="rounded-top" height="200px" />
                  <h4 className="fw-bold py-4">Communication</h4>
                  <p className="pb-3">Our website provides seamless communication between healthcare providers and patients, enhancing the quality of care.</p>
                </div>
              </div>
            </div>
          </div>
