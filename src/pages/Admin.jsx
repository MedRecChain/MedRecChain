...
getallhospitals();
 ...
 getallDoctors();
  ...
  const getallPatients = async () => {
    const pat = await Contract.methods.get_all_Patients().call({ from: acount });
    setPatientdate(pat);
     // for every hospital.
     for(var a = 0; a < Hospitaldate.length ; a++)
     {
  ...
  return (
    <>
      ...
      <section className="py-5 px-5 bg-info-light position-relative overflow-hidden col-10">
      <CChart
          type="bar"
          options={options}
          data={{
