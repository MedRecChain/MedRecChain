      ...
      <div className="row"
        ...
        <div className="col-xl-7" style={{}}>
          <div className="container m-5 p-5">
            ...
            >Make Your Medical Record More Secure.<br /> Be the main controller of your medical record.</p>
            ...
            ><Link
              className="btn bg-light my-5 fs-5 d-block"
              to="/dashboard"
            >
                {`Get Start >`}
              </Link>
                ...
                <div className="row">
                  <div className="col-xl-4 d-flex align-items-stretch">
                    <div className="icon-box mt-4 mt-xl-0">
                      <Icon icon="fluent:cube-link-20-filled" color="#0dcaf0" width="40" height="40" style={{ "marginBottom": "30px" }} />
                      <h4>Based on Blockchain</h4>
                      <p>The entire system of MedRecChain is based on blockchain technology. therefore it is practically secure.</p>
                    </div>
                  </div>
                  <div className="col-xl-4 d-flex align-items-stretch">
                    <div className="icon-box mt-4 mt-xl-0">
                      <Icon icon="fluent:receipt-bag-24-regular" color="#0dcaf0" width="40" height="40" style={{ "marginBottom": "30px" }} />
                  ...
                  <div className="col-xl-4 d-flex align-items-stretch">
                    <div className="icon-box mt-4 mt-xl-0">
                      <Icon icon="bx:bx-images" color="#0dcaf0" width="40" height="40" style={{ "marginBottom": "30px" }} />
                      <h4>IPFS Storage</h4>
